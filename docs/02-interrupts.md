...
kcore/src/cpu/idt.rs        IdtGate struct, set_idt_gate(), lidt
kcore/src/cpu/isr.rs        install handlers, the common Rust isr_handler/irq_handler,
...
### 2. The IDT (`kcore/src/cpu/idt.rs`)
...
### 3. Installing handlers (`kcore/src/cpu/isr.rs`)
