...
push 'C' ; 16 - bit values , so the most significant byte; will be added by our assembler as 0x00.
...
mov al , [0x7ffe ]  ; To prove our stack grows downwards from bp ,
                    ; fetch the char at 0 x8000 - 0x2 ( i.e. 16 - bits because push = 8bit, 'A' = 8 bit  )
int 0x10 ; print (al)
jmp $ ; Jump forever.
